...
public class AddApiController implements AddApi {
    ...
    public ResponseEntity<Model200> currentWeatherData(@NotNull @ApiParam(value = "Left hand side", required = true) @Valid @RequestParam(value = "lhs", required = true) Long lhs,@NotNull @ApiParam(value = "Right hand side", required = true) @Valid @RequestParam(value = "rhs", required = true) Long rhs) {
